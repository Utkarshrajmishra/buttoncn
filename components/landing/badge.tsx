...
export default function ShimmerBadge({ 
  ...
  return ( 
    <div 
      className={cn( 
        "relative w-fit overflow-hidden rounded-full border border-neutral-700 bg-neutral-800 px-4 sm:px-6 md:px-8 py-0.5 sm:py-1 text-xs sm:text-sm text-neutral-200", 
        className 
      )} 
    > 
