...
const pulseButtonVariants = cva(
  "relative inline-flex items-center justify-center overflow-hidden rounded-full font-medium tracking-wider transition-all duration-300 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-violet-600 text-violet-600 hover:text-white",
    ...
    return (
      ...
      >
        ...
        <svg
          ...
          className="pointer-events-none absolute inset-0 w-full h-full opacity-0 scale-125 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out z-0"
          viewBox="0 0 204 113"
