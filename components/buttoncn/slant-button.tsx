    ...
    ({ 
        ...
        return (
            ...
            >
                ...
                <span
                    className="absolute w-[150%] h-32 -top-8 -left-2 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-500 duration-1000 origin-left"
                    style={{ backgroundColor: colors[0] }}
                />
                <span
                    className="absolute w-[150%] h-32 -top-8 -left-2 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-left"
                    style={{ backgroundColor: colors[1] }}
                />
                <span
                    className="absolute w-[150%] h-32 -top-8 -left-2 rotate-12 transform scale-x-0 group-hover:scale-x-50 transition-transform group-hover:duration-1000 duration-500 origin-left"
