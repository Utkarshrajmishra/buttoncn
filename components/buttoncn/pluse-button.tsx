    ...
    return (
      ...
      >
        ...
        <svg
          ...
          className="pointer-events-none absolute inset-0 z-[1] h-full w-full scale-125 opacity-0 transition-all duration-500 ease-out group-hover:scale-100 group-hover:opacity-100"
          viewBox="0 0 204 113"
