---
title: Glass Button
description: A glossy, glass-morphism button with layered highlights and soft gradients, giving a premium, frosted-glass look with depth and shine.
---
...
>
  ...
  ```npm
 npx shadcn@latest add https://fluxbuttons.vercel.app/r/glass-button.json
```
  </Tab>
  <Tab value="Manual" className="bg-transparent border">
  ```tsx title="glass-button.tsx"
"use client"
...
```tsx title="usage.tsx"
import GlassyButton from "@/components/ui/glass-button";
