---
title: Metal Button
description: A beautiful, customizable metal button component with tactile feedback.
---
...
import {
  ...
  MetalButtonGold,
  MetalButtonBronze,
} from "@/components/buttoncn-preview/metal-button-preview";
import { TypeTable } from "fumadocs-ui/components/type-table";

<Preview link="metal-button">
  <MetalButtonDemo />
</Preview>
...
>
  ...
  ```npm
 npx shadcn@latest add https://fluxbuttons.vercel.app/r/metal-button.json
```
  </Tab>
...
<TypeTable
  type={{
     ...
     variant: {
      description: "Visual style of the metal button",
      default:"default",
      type: "default | primary | success | error | gold | bronze",
    },
